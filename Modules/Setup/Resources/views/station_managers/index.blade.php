                                ...
                                <tbody>
                                    @foreach($stationManagers as $manager)
                                        <tr>
                                            ...
                                            <td>{{ $manager->email }}</td>
                                            <td>
                                                @foreach($manager->managedStations as $station)
                                        ...
                                        <div class="modal fade" id="assignStationModal{{ $manager->id }}" tabindex="-1" aria-labelledby="assignStationModalLabel{{ $manager->id }}" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('station_managers.assign_station', $manager->id) }}" method="POST">
                                                            @csrf
                                                            <div class="mb-3">
                                                                <label for="station_id{{ $manager->id }}" class="form-label">Select Station</label>
                                                                <select class="form-select" id="station_id{{ $manager->id }}" name="station_id" required>
                                        ...
                                        <div class="modal fade" id="reassignStationModal{{ $manager->id }}" tabindex="-1" aria-labelledby="reassignStationModalLabel{{ $manager->id }}" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('station_managers.reassign_station', $manager->id) }}" method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                            <div class="mb-3">
                                                                <label for="reassign_station_id{{ $manager->id }}" class="form-label">Select New Station</label>
                                                                <select class="form-select" id="reassign_station_id{{ $manager->id }}" name="station_id" required>
                                                                    @foreach($stations as $station)
                                                                        <option value="{{ $station->id }}">{{ $station->name }}</option>
                                                                    @endforeach
                                                                </select>
