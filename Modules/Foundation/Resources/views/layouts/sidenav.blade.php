<div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-title">Galana Foundation Module</li>
        ...
        <li class="nav-group">
            ...
            <ul class="nav-group-items">
                <li class="nav-item"><a class="nav-link" href="{{ route('bank-details.index') }}"> Bank Details </a></li>
                <li class="nav-item"><a class="nav-link" href="{{route('fees.index')}}"> Fee Payment </a></li>
                <!--<li class="nav-item"><a class="nav-link" href="#"> Reports </a></li>-->
            </ul>
        </li>
        ...
        <li class="nav-group">
            ...
            <ul class="nav-group-items">
                <li class="nav-item"><a class="nav-link" href="{{ route('schools.create') }}"> Create </a></li>    
                <li class="nav-item"><a class="nav-link" href="{{ route('schools.index') }}"> List </a></li>            
            </ul>
        </li>
