                    ...
                    <form action="{{ route('performances.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" name="mid_mean_score" class="form-control" id="mid_mean_score">
                            </div>
                            <div class="form-group col-md-6 mb-3">
                                <label for="mid_term_grade">Mid-Term Grade</label>
                                <input type="text" name="mid_term_grade" class="form-control" id="mid_term_grade">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="mid_term_position" name="mid_term_position_number" placeholder="Position">
                                    <div class="input-group-append">
                                        <span class="input-group-text">out of</span>
                                    </div>
                                    <input type="number" class="form-control" id="mid_term_position_total" name="mid_term_position_total" placeholder="Total Students">
                                </div>
                            </div>
                            <div class="form-group col-md-6 mb-3">
                                <label for="end_term_position">End-Term Position</label>
                                <div class="input-group">
                                    <input type="number" class="form-control" id="end_term_position" name="end_term_position_number" placeholder="Position">
                                    <div class="input-group-append">
                                        <span class="input-group-text">out of</span>
                                    </div>
                                    <input type="number" class="form-control" id="end_term_position_total" name="end_term_position_total" placeholder="Total Students">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" name="end_term_mean_score" class="form-control" id="end_term_mean_score">
                            </div>
                            <div class="form-group col-md-6 mb-3">
                                <label for="end_term_grade">End-Term Grade</label>
                                <input type="text" name="end_term_grade" class="form-control" id="end_term_grade">
                            </div>
